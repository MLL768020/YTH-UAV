...
def generate_data(images_dir, labels_dir, label_name):
    ...
    if filetype == 'xml':
        bbs = parsexml(labels_dir + label_name)
...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='datasets/RFRB',
...
if __name__=='__main__':
    ...
    rootdir = './datasets/RFRB_processed'
    filelist = []
    ...
    if not os.path.exists("./datasets/RFRB_processed"):
        os.makedirs("./datasets/RFRB_processed2")
    if not os.path.exists("./datasets/RFRB_processed/train"):
        os.makedirs("./datasets/RFRB_processed/train")
    if not os.path.exists("./datasets/RFRB_processed/val"):
        os.makedirs("./datasets/RFRB_processed/val")
    if not os.path.exists("./datasets/RFRB_processed/test"):
        os.makedirs("./datasets/RFRB_processed/test")
