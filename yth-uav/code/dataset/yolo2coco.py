...
parser.add_argument('--image_path', default='/home/cv/lyh/datasets/WEDU/val/images/', type=str,
                    help="path of images")
parser.add_argument('--label_path', default='/home/cv/lyh/datasets/WEDU/val/labels', type=str,
                    help="path of labels .txt")
parser.add_argument('--save_path', type=str, default='/home/cv/lyh/datasets/WEDU/annotations/instances_val2017.json',
