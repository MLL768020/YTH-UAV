...
from ultralytics.nn.modules import C2f, Detect, RTDETRDecoder,RTDETRDecoder1
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        for m in model.modules():
            if isinstance(m, (Detect, RTDETRDecoder,RTDETRDecoder1)):  # Segment and Pose use Detect base class
