...
from ultralytics.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8PoseLoss, v8SegmentationLoss,v8DetectionLoss1
...
class DetectionModel1(BaseModel):
    """YOLOv8 detection model."""
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 BottleNeck_DCNv2_Dynamic,SPPD,DBSPP,ASPP,SPPELAN,SPPCSPC,
                 ...
                 C3_AggregatedAtt, C2f_AggregatedAtt, C2f_DBB, FSM,LSPP,
                 SELayer):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (
                    ...
                    C3_Faster_Rep_EMA,
                    C2f_Faster_Rep_EMA, CSP_EDLAN, Conv3XCC3, C2f_DBB,SPPCSPC):
        ...
        elif m is RTDETRDecoder1:  # special case, channels arg must be passed in index 1
            args.insert(1, [ch[x] for x in f])
